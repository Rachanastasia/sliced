  ...
  return (
    <div id="about" className={styles.about_wrapper}>
      ...
      <p className={styles.about_p}>
        ...
        days. To convert recipes to the lowest common denominator of what I had
        on-hand, I kept asking Siri{' '}
        ...
        scale down amounts and units, and provide a visual reference of the new
        ingredients.
      </p>
