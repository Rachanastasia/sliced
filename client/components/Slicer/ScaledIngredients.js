...
import { IngredientItem } from '../elements'
...
//       {ingredient.amount > 0 && (
//         <p className={styles.preview_ingredient_item}>{formattedAmount}</p>
//       )}
//       <p
//         className={`${styles.preview_ingredient_item} ${styles.preview_unit_item}`}
//       >
//         {ingredient.unit?.name && formattedUnit}
//       </p>
//       <p
//         className={`${styles.preview_ingredient_item} ${styles.preview_ingredient_item}`}
//       >
//         {ingredient.ingredient}
//       </p>
//     </li>
...
//     setConstant(option)
//   }
//   const makeLabel = ({ index, label }) =>
//     index === 0 || index === 10 ? label : ' '
//   return (
//     <div>
//       <form>
//         <input
